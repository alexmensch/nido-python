...
#
# Modified to force instantiator of Daemon class to specify pidfile and working directory
# 
...
class Daemon:
        ...
        Usage: subclass the Daemon class and override the run() and quit() methods
        """
        ...
        def daemonize(self):
                ...
                # Register anonymous function for graceful exit on receiving SIGTERM
